...
public class WebServiceStatusCodeUnitTest extends BaseWebServiceTest {
  ...
  public void deleteTypeParamWithExpectedStatus() throws IOException, InterruptedException {
    var result = this.webServiceDriver.delete(baseUrl +"/api/XML_JSON/Delete/1",
        MediaType.APP_JSON, Product.class, HttpStatus.OK);
    Assert.assertNull(result);

    result = this.webServiceDriver.delete(baseUrl +"/api/XML_JSON/Delete/1",
