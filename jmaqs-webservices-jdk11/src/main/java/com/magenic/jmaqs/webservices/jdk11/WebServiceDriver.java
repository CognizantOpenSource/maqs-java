...
public class WebServiceDriver {
   ...
   * @throws InterruptedException if exception is thrown
   */
  public <T> T get(String requestUri, MediaType expectedMediaType, HttpStatus expectedStatus,
   ...
   */
  protected HttpResponse<String> getContent(String requestUri, MediaType mediaType,
      boolean expectSuccess) throws IOException, InterruptedException {
   ...
   * @throws InterruptedException if the exception is thrown
   */
  protected <T> T getContent(String requestUri, MediaType mediaType, boolean expectSuccess,
      Type type) throws IOException, InterruptedException {
    this.checkIfMediaTypeNotPresent(mediaType.toString());
   ...
   * @throws InterruptedException if the exception is thrown
   */
  protected <T> T getContent(String requestUri, MediaType mediaType, HttpStatus expectedStatus,
      Type type) throws IOException, InterruptedException {
    this.checkIfMediaTypeNotPresent(mediaType.toString());
  ...
  public HttpResponse<String> put(String requestUri, MediaType expectedMediaType, String content,
    ...
    HttpResponse<String> response = this
        .putContent(requestUri, expectedMediaType, content, expectedStatus);
   ...
   * @throws InterruptedException if the exception is thrown
   */
  public String put(String requestUri, MediaType expectedMediaType, String content,
      boolean expectSuccess) throws IOException, InterruptedException {
    HttpResponse<String> response = this
        .putContent(requestUri, expectedMediaType, content, expectSuccess);
  ...
  public String put(String requestUri, MediaType expectedMediaType, String content,
      ...
      throws IOException, InterruptedException {
    HttpResponse<String> response = this
        .putContent(requestUri, expectedMediaType, content, postMediaType, contentAsString,
            expectSuccess);
    return response.body();
  }
  ...
  public String put(String requestUri, MediaType expectedMediaType, String content,
      ...
      throws IOException, InterruptedException {
    HttpResponse<String> response = this
        .putContent(requestUri, expectedMediaType, content, postMediaType, expectedStatus,
            contentAsString);
    return response.body();
  }
   ...
   * @throws InterruptedException if the exception is thrown
   */
  protected HttpResponse<String> putContent(String requestUri, MediaType expectedMediaType,
    ...
    return this.putContent(requestUri, expectedMediaType, httpContent, expectSuccess);
  }
  ...
  protected HttpResponse<String> putContent(String requestUri, MediaType expectedMediaType,
      ...
      throws IOException, InterruptedException {
    String httpContent = createContent(content, postMediaType, contentAsString);
    return this.putContent(requestUri, expectedMediaType, httpContent, expectedStatus);
  }
  ...
  private static void ensureSuccessStatusCode(HttpResponse<String> response) {
    ...
    if (response.statusCode() != HttpStatus.OK.value()) {
      throw new NotAcceptableStatusException(String
          .format("Response did not indicate a success. %s Response code was: %d",
   ...
   * @param expectedStatus Assert a specific status code was returned
   */
  private static void ensureStatusCodesMatch(HttpResponse<String> response,
    ...
    if (response.statusCode() != expectedStatus.value()) {
      ...
      throw new NotAcceptableStatusException(String.format(
          "Response status did not match expected. %s "
              + "Response code was: %d %s Expected code was: %d %s" + "Body: %s",
          System.lineSeparator(), response.statusCode(), System.lineSeparator(),
          expectedStatus.hashCode(), System.lineSeparator(), body));
    }
  }
