...
import com.cognizantsoftvision.maqs.utilities.helper.functionalinterfaces.Action;
  ...
  protected WebElement getElement(Supplier<WebElement> getElement) {
    if (this.getCachedElement() != null) {
      try {
        ...
        this.getTestObject().getLogger()
            .logMessage(MessageType.VERBOSE, "Re-finding element because: " + e.getMessage());
      }
    }
