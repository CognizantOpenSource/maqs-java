...
public class ElementHandlerUnitTests {
  ...
  public void createSortedCommaDelimitedStringFromWebElementsTest() {
    ...
    navigateToUrl();
    Assert.assertEquals(
        ElementHandler.createCommaDelimitedString(webDriver, computerPartsListOptions, true),
  ...
  public void createCommaDelimitedStringFromWebElementsTest() {
    ...
    navigateToUrl();
    Assert.assertEquals(
        ElementHandler.createCommaDelimitedString(webDriver, computerPartsListOptions),
        expectedText, "Expected String does not match actual");
  }
  ...
  public void checkCheckBoxTest() {
    ...
    Assert.assertTrue(seleniumWait.waitForClickableElement(checkbox).isSelected(),
  ...
  public void selectItemFromDropDownTest() {
    ...
    String actualSelection = ElementHandler.getSelectedOptionFromDropdown(seleniumWait,
        nameDropdown);
  ...
  public void selectMultipleItemsFromListBoxTest() {
    ...
    navigateToUrl();
    ElementHandler.selectMultipleElementsFromArrayListBox(seleniumWait, computerPartsList,
        itemsToSelect);
  ...
  public void selectMultipleItemsFromListBoxTestByValue() {
    ...
    navigateToUrl();
    ElementHandler.selectMultipleElementsFromArrayListBoxByValue(seleniumWait, computerPartsList,
        itemsToSelect);
    ArrayList<String> selectedItems = ElementHandler.getSelectedOptionsFromDropdown(seleniumWait,
        computerPartsList);
  ...
  public void slowTypeTest() {
    ...
    Assert.assertEquals(
        seleniumWait.waitForClickableElement(firstNameTextBox).getAttribute("value"),
        "Test input slowtype");
  }
