//--------------------------------------------------
// <copyright file="WebDriverFindExtensions.java" company="Magenic">
...
public class WebElementFind
{
	 ...
	 * @return Returns a Web Element
	 */
	public static WebElement findElementWithText(WebDriver driver, By by, String text, boolean throwException)
	{
	 ...
	 */
	public static int findIndexOfElementWithText(WebDriver driver, By by, String text, boolean throwException)
	{
	 ...
	 */
	public static int findIndexOfElementWithText(List<WebElement> list, String text, boolean throwException)
	{
		int index = -1;
		...
		if ((list == null || list.size() == 0) && throwException == true)
		{
			throw new NotFoundException(
					StringProcessor.safeFormatter("Empty or null Element Collection passed in %s", list.toString()));
		}
		...
		throw new NotFoundException(
				StringProcessor.safeFormatter("Text did not match any element in collection %s", list.toString()));
	}
	...
	private static List<WebElement> elemList(WebDriver driver, By by, boolean throwException)
	{
		...
		throw new NotFoundException(StringProcessor.safeFormatter("No result found for By %s", by.toString()));
	}
