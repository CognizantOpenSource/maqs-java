//--------------------------------------------------
// <copyright file="ElementHandler.java" company="Magenic">
//  Copyright 2017 Magenic, All rights Reserved
// </copyright>
// <summary>Helper class for handling webelement objects</summary>
//--------------------------------------------------
...
public class ElementHandler {
	 ...
	 * @param by
	 *            By selector for the element
	 * @return ArrayList<String> of selected items in dropdown
	 */
	...
	/**
	 * Check or Uncheck a checkbox NOTE: If checkbox is already in desired
	 * state, this method takes no action
	 * 
	 * @param seleniumWait
	 *            SeleniumWait Object
	 * @param by
	...
	/**
	 * Enter text into a textbox. NOTE: This function clears the textbox before
	 * entering text
	 * 
	 * @param seleniumWait
	 *            SeleniumWait Object
	...
	/**
	 * Method to click an element via JavaScript Used for scenarios where normal
	 * click can't reach, such as hidden or hover triggered elements.
	 * 
	 * @param webDriver
	 *            The WebDriver
	 * @param by
	...
	/**
	 * Method to slowly type a String Used for scenarios where normal SendKeys
	 * types too quickly and causes issues with a website
	 * 
	 * @param seleniumWait
	 *            SeleniumWait Object
	 * @param by
