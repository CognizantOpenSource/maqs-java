# <img src="resources/jmaqslogo.jpg" height="32" width="32"> Configurations

## Introduction
The below section will cover global test settings.

## Application Configuration
The JMAQS project solutions make use of a collection of configurations. 
These configurations are stored in an XML document called the **app.config**.
The **config.xml** file includes configurations for each project solution, as well as generic configurations for handling JMAQS specific functions.
...
# Full Configuration
## App.Config
Primarily used with Maven implementation of JMAQS.
```xml
...
<configuration>
  ...
  <SeleniumMaqs>
    ...
    <!-- Web driver hint path override - This is the first place JMAQS will try to find your web drive -->
...
```
## appsettings.json
Primarily uses with the .Net Core implementation of JMAQS.
```json
{
  "MagenicMaqs": {
    "WaitTime": "100",
