 ...
 */
public class JUnit_BaseTestObjectUnitTest extends BaseGenericTest {
    ...
    public void testAddDriverManager() {
        ...
        Assertions.assertEquals(testObject.getManagerStore().size(), 0, "Checking that manager store is empty");
        testObject.addDriverManager(driverManager);
        Assertions.assertEquals(testObject.getManagerStore().size(), 1, "Checking that manager store has 1 object added");
    ...
    public void testClose() {
        ...
        Assertions.assertEquals(testObject.getValues().size(), 0, "Checking if values in manager store are closed");
    ...
    public void testAddAssociatedFile() {
        ...
        Assertions.assertEquals((testObject.getArrayOfAssociatedFiles()).length, 1,
    ...
    public void testRemoveAssociatedFile() {
        ...
        Assertions.assertTrue(testObject.removeAssociatedFile(path), "Checking that assocai");
    }
    ...
    public void testGetArrayOfAssociatedFiles() {
        ...
        Assertions.assertEquals(testObject.getArrayOfAssociatedFiles().length, 1, "Checking that array is not empty");
    }
